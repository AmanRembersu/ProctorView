function About(){
  ...
  return(
    ...
    <header className="bg-black border-b border-gray-700 p-6">
      <div className="container mx-auto flex justify-between items-center">
        <h1 className="text-2xl font-bold text-white">ProctorView Documentation</h1>
  ...
  <footer className="bg-gray-900 border-t border-gray-700 text-gray-500 text-center py-6 mt-20">
    <p>
      &copy; 2025 ProctorView. All rights reserved.
    </p>
  </footer>
